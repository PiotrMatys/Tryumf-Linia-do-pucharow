    ...
    switch(pozycja_wiezy)
        ...
        case 0:
                ...
                switch(PINA.0)
                    ...
                    case 1:
                        delay_ms(50);   //filtruje ewentualne zaklocenia, aby miec pewnosc ze sygnal nastapil
                        if(PINA.0 == 1)
                            {
                            if(PINA.1 == 1)
                                kamien = 50;
        ...
        case 10:
                ...
                PORTA.7 = 1;
                while(PINA.0 == 1)    
                    PORTA.7 = 1;  //sygnal ze dojechalem
                pozycja_wiezy = 0;
                delay_ms(200);
                PORTA.7 = 0;
...
switch(proces[0])
    ...
    case 1:                          //zeby wrocila karetka nakretek
...
switch(proces[3])
    ...
    case 0: //pedal monter 2   //
        if(PINE.2 == 1 & zezwolenie_od_master == 1)
            {
            PORTC.5 = 1;     //wysun silownik otwierajacy wieze
            PORTC.6 = 0;     //wysun silownik otwierajacy wieze
            if(wieza == 0)
                PORTC.2 = 0;  //stan otwart wejsciowy wie풹 1
            else
                {
                PORTC.3 = 1;  //stan otwarcia wejsciowy wie풹 2 
                PORTC.7 = 0;  //stan otwarcia wejsciowy wie풹 2
                }
            sek3 = 0;       
            proces[3] = 1;
            }    
    ...
    case 2:
            ...
            if(wieza == 0)
                ...
                {
                PORTC.3 = 0;  //stan zamkniecia wejsciowy wie풹 2 
                PORTC.7 = 1;  //stan zamkniecia wejsciowy wie풹 2
                //wieza = 0;
                }
            sek3 = 0;       
            proces[3] = 3;
...
while(basia1 < 1000)  //musimy przejechac tak, ze na pewno miniemy czujnuk gdybysmy byli miedzy nimi, zmieniam mikrokroki wiec daje mniej, by쿽 2000
    {                                                         //2000 //1000  //500
    PORTE.5 = 1;
    delay_us(1000);
    PORTE.5 = 0;
...
//teraz sie cofniemy
PORTE.4 = 1;  //zmieniamy dir
while(basia1 < 250)  //musimy przejechac tak, ze na pewno miniemy czujnuk gdybysmy byli miedzy nimi, zmieniam mikrokroki wiec daje mniej, by쿽 2000
    {                                                         //2000 //1000  //500
    PORTE.5 = 1;
    delay_us(500);
    PORTE.5 = 0;
...
PORTA.7 = 1;  //potwierdzam wypozycjonowanie
delay_ms(1000);
PORTA.7 = 0;
